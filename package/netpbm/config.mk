...
STAGING_DIR=/home/mcli/projects/irvinecubesat/buildroot/output/staging/
JPEGLIB = $(STAGING_DIR)/usr/local/lib/libjpeg.so
JPEGHDR_DIR = $(STAGING_DIR)/usr/local/include/
#JPEGLIB = libjpeg.so
